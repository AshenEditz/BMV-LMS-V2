// TeacherLayout.js - Similar structure to StudentLayout
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-white text-sm"><FaUser className="inline mr-2" />{teacher?.name}</div>
      ...
      <footer className="glass-effect border-t border-white/10 mt-12">
        <div className="max-w-7xl mx-auto px-4 py-6 text-center text-gray-400 text-sm">
          <p>© 2025 Buthpitiya M.V. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
